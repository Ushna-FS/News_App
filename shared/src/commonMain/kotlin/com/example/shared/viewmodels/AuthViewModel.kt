...
class AuthViewModel(
    ...
    fun login(
        ...
        if (!networkMonitor.isConnected()) {
            onError(Res.string.no_internet_connection)
            return
        }
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (userId != null) {
                    ...
                    onError(Res.string.user_id_not_found)
                }
                    ...
                    is FirebaseAuthException -> {
                        ...
                        when {
                            "user-not-found" in errorMsg ->
                                Res.string.account_does_not_exist

                            "wrong-password" in errorMsg ||
                                    "invalid-credential" in errorMsg ->
                                Res.string.incorrect_email_or_password

                            else ->
                                Res.string.login_failed_please_try_again
                        }
                    }

                    else -> Res.string.login_failed_please_try_again
                }
    ...
    fun signup(
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                onError(Res.string.signup_failed)
            }
        }
    }
